...
# ✅ Load OpenAI API key from Streamlit secrets only
openai_key = st.secrets.get("OPENAI_API_KEY")
if not openai_key:
    raise ValueError("❌ OpenAI API key not found in Streamlit secrets. Please add it to your app settings.")
...
# ✅ Keywords for relevant questions and content filtering
ALLOWED_KEYWORDS = [
...
if uploaded_pdfs:
    ...
    st.info("📄 You can upload HVAC or CAD PDFs to improve the chatbot's responses.")
